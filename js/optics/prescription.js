...
*/
      ...
      lens.pointsTable = new Tabulator("#lens-points", {
        ...
        columns:[
            ...
            {title:"<i>l<sub>v&prime;</sub></i>", field:"zi", visible:true,  width:100, editor:"input", headerSort:false, mutator:Number, formatter: decimalPlaces, formatterParams:{ precision: 6, emptyVal: "--" },  cellEdited:  defaultEditFunction, editable:editPointCheck },                  
